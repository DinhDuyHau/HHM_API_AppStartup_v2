...
using Voucher.ORTran.Models;

namespace Voucher.ORTran
{
    public class Service : IVoucherService
    {
        //Mã chứng từ
        public string VoucherCode { get; } = "PTK";

        //Bảng gốc dữ liệu không phân kỳ
        public string MasterTable { get; } = "c541$000000";

        //Bảng chính chứa dữ liệu phân kỳ
        public string PrimeTable { get; } = "m541$";

        //Bảng lưu thông tin tìm kiếm
        public string InquiryTable { get; } = "i541$";

        //Bảng lưu dữ liệu chi tiết của chứng từ
        public string DetailTable { get; } = "d541$";
        private const string _DETAIL_PARA = "d541";

        // bảng lưu dữ liệu chi tiết của thanh toán
        public string PaidTable { get; } = "d541tt$";
        private const string _PAID_PARA = "d541tt";

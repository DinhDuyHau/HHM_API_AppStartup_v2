...
namespace Voucher.SVTran_BHE
{
    ...
    {
        //Mã chứng từ
        public string VoucherCode { get; } = "BHE";

        //Bảng gốc dữ liệu không phân kỳ
        public string MasterTable { get; } = "c595$000000";

        //Bảng chính chứa dữ liệu phân kỳ
        public string PrimeTable { get; } = "m595$";

        //Bảng lưu thông tin tìm kiếm
        public string InquiryTable { get; } = "i595$";

        //Bảng lưu dữ liệu chi tiết của chứng từ
        public string DetailTable { get; } = "d595$";
        private const string _DETAIL_PARA = "d595";


        //Bảng lưu dữ liệu chi tiết của dịch vụ
        public string DetailDVTable { get; } = "d595dv$";
        private const string _DETAIL_DV_PARA = "d595dv";


        //Bảng lưu dữ liệu chi tiết của chiết khấu
        public string DetailCkTable { get; } = "d595ck$";
        private const string _DETAIL_CK_PARA = "d595ck";


        //Bảng lưu dữ liệu chi tiết của thanh toán
        public string DetailTtTable { get; } = "d595tt$";
        private const string _DETAIL_TT_PARA = "d595tt";


        //Bảng lưu dữ liệu chi tiết của bảo hành
        public string DetailbhTable { get; } = "d595bh$";
        private const string _DETAIL_BH_PARA = "d595bh";
        ...
        public string Operation { get; } = "ma_kh,ma_dvcs,ma_cuahang,ma_ca;#10$,#20$,#30$, #40$; , , , :ma_kho,ma_vt,ma_imei;#10$,#20$,#30$;d595,d595,d595";
...
SELECT is_success, message FROM @check";
        ...
        public CommonObjectModel Updated(object voucherItem, Query voucherQuery, int user_id)
        {
            ...
            //    $" t_tt_nt = @t_tt_nt, t_tt = @t_tt_nt, ma_gd = @ma_gd, loai_ct = @loai_ct, user_id2 = {user_id}, datetime2 = getdate(), ma_nvbh = @ma_nvbh, ma_nvvc = @ma_nvbh ";

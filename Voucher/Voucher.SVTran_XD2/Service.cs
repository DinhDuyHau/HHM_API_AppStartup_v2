...
namespace Voucher.SVTran_XD2
{
    ...
    {
        //Mã chứng từ
        public string VoucherCode { get; } = "XD2";

        //Bảng gốc dữ liệu không phân kỳ
        public string MasterTable { get; } = "c526$000000";

        //Bảng chính chứa dữ liệu phân kỳ
        public string PrimeTable { get; } = "m526$";

        //Bảng lưu thông tin tìm kiếm
        public string InquiryTable { get; } = "i526$";

        //Bảng lưu dữ liệu chi tiết của chứng từ
        public string DetailTable { get; } = "d526$";
        private const string _DETAIL_PARA = "d526";

        //Bảng lưu dữ liệu chi tiết của thanh toán
        public string DetailTtTable { get; } = "d526tt$";
        private const string _DETAIL_TT_PARA = "d526tt";
        ...
        public string Operation { get; } = "ma_kh,ma_dvcs,ma_cuahang,ma_ca;#10$,#20$,#30$, #40$; , , , :ma_kho,ma_dv;#10$,#20$;d526,d526";
            ...
            if (data.details.Any(x => x.Id == index_value) && vc_item.details.Any(x => x.Id == index_value))
            {
                ...
                if (item_model != null && item_detail != null)
                {
                    ...
                    if (detail_list != null && detail_list.Count > 0)
                    {
                        ...
                        {
                            serviceModels.Add(new ServiceDetailBase
                            {
...
SELECT is_success, message FROM @check";
        ...
        public CommonObjectModel Updated(object voucherItem, Query voucherQuery, int user_id)
        {
            ...
            if (voucherQuery.Details.Any(x => x.ParaName == _DETAIL_PARA))
            {
                ...
                query += $"insert into {detail_table} (stt_rec,stt_rec0,ma_ct,ngay_ct,so_ct,tk_dt,tien_nt2,tien2,dien_giai,ma_thue,thue_suat,tk_thue,thue_nt,thue,tk_ck,tl_ck,ck_nt,ck,tt,tt_nt,ma_kh2,ma_vv,ma_sp,ma_bp,so_lsx,line_nbr,ma_hd,ma_ku,ma_phi,so_dh_i,ma_td1,ma_td2,ma_td3,sl_td1,sl_td2,sl_td3,ngay_td1,ngay_td2,ngay_td3,gc_td1,gc_td2,gc_td3,s1,ma_ca,ma_cuahang,s4,s5,s6,s7,s8,s9,dvt,so_luong,gia,gia_nt,ma_dv) select stt_rec,stt_rec0,ma_ct,ngay_ct,so_ct,tk_dt,tien_nt2,tien2,dien_giai,ma_thue,thue_suat,tk_thue,thue_nt,thue,tk_ck,tl_ck,ck_nt,ck,tt,tt_nt,ma_kh2,ma_vv,ma_sp,ma_bp,so_lsx,line_nbr,ma_hd,ma_ku,ma_phi,so_dh_i,ma_td1,ma_td2,ma_td3,sl_td1,sl_td2,sl_td3,ngay_td1,ngay_td2,ngay_td3,gc_td1,gc_td2,gc_td3,s1,ma_ca,ma_cuahang,s4,s5,s6,s7,s8,s9,dvt,so_luong,gia,gia_nt,ma_dv from @{_DETAIL_PARA}";
            }

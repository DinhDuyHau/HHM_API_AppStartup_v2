...
namespace Voucher.CDTran_PCH
{
    ...
    {
        //Mã chứng từ
        public string VoucherCode { get; } = "PCH";

        //Bảng gốc dữ liệu không phân kỳ
        public string MasterTable { get; } = "c555$000000";

        //Bảng chính chứa dữ liệu phân kỳ
        public string PrimeTable { get; } = "m555$";

        //Bảng lưu thông tin tìm kiếm
        public string InquiryTable { get; } = "i555$";

        //Bảng lưu dữ liệu chi tiết của chứng từ
        public string DetailTable { get; } = "d555$";
        private const string _DETAIL_PARA = "d555";

        public string ma_ct_goc { get; } = "PC1";
        ...
        public CommonObjectModel Inserted(object voucherItem, Query voucherQuery, int user_id)
        {
            ...
            if (voucherQuery.Details.Any(x => x.ParaName == _DETAIL_PARA))
            {
                ...
                query += "\n\n";
                query += $"insert into {detail_table} (stt_rec,stt_rec0,ma_ct,ngay_ct,so_ct,dien_giai,tk_no,tien_nt,tien,ma_kh_i,ma_vv,ma_sp,ma_bp,so_lsx,tt_qd,stt_rec_tt, ma_thue, tk_thue, thue_suat, loai_hd, thue, thue_nt, tt,tt_nt, ngay_ct0, so_seri0, mau_bc, ma_tc, ma_kh, ten_kh, dia_chi, ma_so_thue, ma_kh2, ten_vt, ghi_chu, ty_gia_ht2,tien_ht_nt,tien_ht,line_nbr,ma_hd,ma_ku,ma_phi,so_dh_i,ma_td1,ma_td2,ma_td3,sl_td1,sl_td2,sl_td3,ngay_td1,ngay_td2,ngay_td3,gc_td1,gc_td2,gc_td3,s1,ma_ca,ma_cuahang,s4,s5,s6,s7,s8,s9, ma_vt, ma_ctr, tien_coc) select stt_rec,stt_rec0,ma_ct,ngay_ct,so_ct,dien_giai,tk_no,tien_nt,tien_nt,ma_kh_i,ma_vv,ma_sp,ma_bp,so_lsx,tt_qd,stt_rec_tt, ma_thue, tk_thue, thue_suat, loai_hd, thue_nt, thue_nt, tt_nt,tt_nt, ngay_ct0, so_seri0, mau_bc, ma_tc, ma_kh, ten_kh, dia_chi, ma_so_thue, ma_kh2, ten_vt, ghi_chu, ty_gia_ht2,tien_ht_nt,tien_ht,line_nbr,ma_hd,ma_ku,ma_phi,so_dh_i,ma_td1,ma_td2,ma_td3,sl_td1,sl_td2,sl_td3,ngay_td1,ngay_td2,ngay_td3,gc_td1,gc_td2,gc_td3,s1,ma_ca,ma_cuahang,s4,s5,s6,s7,s8,s9, ma_vt, ma_ctr, tien_coc from @{_DETAIL_PARA}";
            }

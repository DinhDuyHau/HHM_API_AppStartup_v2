...
namespace Voucher.IRTran_PNW
{
    public class Service : IVoucherService
    {
        ...
        {
            Authoriztion authoriztion = CommonService.GetAuthoriztion("IRTran_PNW");

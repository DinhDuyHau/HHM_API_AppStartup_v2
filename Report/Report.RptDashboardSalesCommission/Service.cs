...
namespace Report.RptDashboardSalesCommission
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptDashboardSalesCommission";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"exec rs_rptDashboardSalesCommission @userID, @userName";

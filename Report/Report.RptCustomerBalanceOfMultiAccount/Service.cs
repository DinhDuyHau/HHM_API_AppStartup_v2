...
namespace Report.RptCustomerBalanceOfMultiAccount
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptCustomerBalanceOfMultiAccount";
...
exec rs_rptCustomerBalanceOfMultiAccount @tu_ngay, @den_ngay, @tk, @ma_kh, @nh_kh1, @nh_kh2, @nh_kh3, '', 'ma_kh', @ma_dvcs, 'v', @user_id, @admin
            ";

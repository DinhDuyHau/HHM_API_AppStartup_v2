...
using Report.RptDashboardSales;
...
namespace Report.RptDashboardSales
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptDashboardSales";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"exec rs_rptDashboardSales @loginShop, @userID, @admin";

...
namespace Report.RptLookupInventory
{
    public class Service : IReportService
    {
        ...
        sql = @"declare @c varchar(1024)
            ...
            exec rs_rptLookupInventory @ngay, @loginShop, @ma_cuahang, @ma_kho, @ma_vt, @nh_vt1, @nh_vt2, @nh_vt3, @nh_vt4, @c, @ma_dvcs, @loai_ky, 'ma_vt',  @loai_du_lieu, 'v', @user_id, @admin, @nh_vt5, @nh_vt6, @ma_nganh, @ma_loai, 0
";

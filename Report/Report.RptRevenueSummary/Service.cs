...
namespace Report.RptRevenueSummary
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptRevenueSummary";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"select @tu_ngay as tu_ngay, @den_ngay as den_ngay
                    exec rs_rptRevenueSummary @tu_ngay, @den_ngay, @ma_cuahang, @loginShop, 'v', @user_id, @admin";

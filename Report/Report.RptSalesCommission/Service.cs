...
namespace Report.RptSalesCommission
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptSalesCommission";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"select cast(@tu_ngay as smalldatetime) as date_from, cast(@den_ngay as smalldatetime) as date_to, @ma_cuahang as ma_cuahang
                    exec rs_rptSalesCommission @tu_ngay, @den_ngay, @ma_cuahang, 'v', @user_id, @admin, @loginShop, @ma_ca, @ma_nvbh,
							@nh_vt1, @nh_vt2, @nh_vt3, @nh_vt4, @nh_vt5, @ma_nganh";

...
exec rs_rptPaymentMethodsDetail @tu_ngay, @den_ngay, '', '', @ma_nvbh, @ma_kh, @ma_kho, '', '', '', @ma_dvcs, '', '', '', '',
								'HDA, HD1', '2', 12, N'a.ngay_ct, a.ma_ct, a.so_ct', '1', @ma_cuahang, @ma_ca, 'v', @user_id, @admin
            ";

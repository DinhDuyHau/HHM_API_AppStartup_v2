...
namespace Report.RptReturnedgoods
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptReturnedgoods";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"declare @voucherList varchar(512)
                    select @voucherList = 'HD4';	
                    select @ngay_ct1 as date_from, @ngay_ct2 as date_to
                    exec rs_rptReturnedgoods  @ngay_ct1, @ngay_ct2, @ma_vt_doi, @ma_vt_tra, @ma_kh, @ma_kho, @ma_vv, @ma_nx, @ma_hd, @ma_bp,
                      @tk_vt, @nh_vt1, @nh_vt2, @nh_vt3, @nh_vt4, @nh_vt5, @ma_nganh, @ds_ma_gd, @voucherList,
                      @so_ct1, @so_ct2, @ma_dvcs, @loginShop, @ma_cuahang, @ma_ca, @ma_lo, @ma_td1, @ma_td2, @ma_td3, @maxLength, '1', 'ngay_ct', @loai_du_lieu, 'v', @user_id, @admin, @ma_nh_kho";
            ...
            list_paras.Add(new SqlParameter
            {
                ParameterName = "@ma_vt_tra",
                SqlDbType = SqlDbType.VarChar,
                SqlValue = obj_param.ma_vt_tra
            });
            list_paras.Add(new SqlParameter
            {
                ParameterName = "@ma_vt_doi",
                SqlDbType = SqlDbType.VarChar,
                SqlValue = obj_param.ma_vt_doi
            });
            list_paras.Add(new SqlParameter
            {
                ParameterName = "@tk_vt",

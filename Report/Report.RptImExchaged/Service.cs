...
namespace Report.RptImExchaged
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptImExchaged";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"declare @voucherList varchar(512)
                    select @voucherList = 'PNA,HDA';	
                    select @ngay_ct1 as date_from, @ngay_ct2 as date_to
                    exec rs_rptImExchaged  @ngay_ct1, @ngay_ct2, @ma_vt, @ma_kh, @ma_kho, @ma_vv, @ma_nx, @ma_imei, @ma_hd, @ma_bp,

...
namespace Report.RptCashBookByDayStore
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptCashBookByDayStore";
        ...
        select cast(@tu_ngay as smalldatetime) as date_from, cast(@den_ngay as smalldatetime) as date_to,
	            @tk as tk, @accountname as ten_tk, @accountname2 as ten_tk2, @ma_cuahang as ma_cuahang, @ma_ca as ma_ca
	    exec rs_rptcashbookbydayStore @tu_ngay, @den_ngay, @ma_dvcs, @tk, 'v', @user_id, @admin, @ma_cuahang, @ma_ca, @loginShop";

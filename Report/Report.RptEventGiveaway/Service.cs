...
namespace Report.RptEventGiveaway
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptEventGiveaway";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @" select @tu_ngay as tu_ngay, @den_ngay as den_ngay
                    exec rs_rptEventGiveaway @tu_ngay, @den_ngay, @so_ct1, @so_ct2, @ma_sukien, @ma_vt, @ma_cuahang,
						 @nh_vt1, @nh_vt2, @nh_vt3, @nh_vt4, @nh_vt5, @ma_nganh, @maxLength, 'v', @user_id, @admin, @loginShop
            ";

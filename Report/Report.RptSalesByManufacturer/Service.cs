...
using Report.RptSalesByManufacturer;
...
namespace Report.RptSalesByManufacturer
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptSalesByManufacturer";
        ...
        public List<SqlParameter> init(ParamItem obj_param, out string sql)
        {
            ...
            sql = @"
		        ...
		        exec rs_rptRevenuebyManufacturer @tu_ngay, @den_ngay, @nh_vt2, @nh_vt1, @loai_bc, 'v', @userID, @admin
            ";
            ...
            list_paras.Add(new SqlParameter
            {
                ParameterName = "@loai_bc",
                SqlDbType = SqlDbType.VarChar,
                SqlValue = obj_param.type
            });

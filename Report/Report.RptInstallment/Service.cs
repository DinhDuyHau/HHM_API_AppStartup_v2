...
namespace Report.RptInstallment
{
    public class Service : IReportService
    {
        ...
        public string controller { get; set; } = "rptInstallment";
...
exec rs_rptInstallment @ngay_ct1, @ngay_ct2, @so_ct1, @so_ct2, @ma_kh, @tk, @ma_vv, @ma_hd, @ma_bp, @ma_dvcs, @ma_lo, @ma_td1, @ma_td2, @ma_td3,
								'HDA, HD1', '2', @maxLength, N'a.ngay_ct, a.ma_ct, a.so_ct', '1', @ma_cuahang, @ma_ca, 'v', @user_id, @admin, @ma_dvtg, @loginShop       
";
